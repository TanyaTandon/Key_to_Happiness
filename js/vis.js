  ...
  BubbleChart = (function() {
    ...
    BubbleChart.prototype.create_nodes = function() {
      this.data.forEach((function(_this) {
        return function(d) {
          ...
          node = {
            id: d.id,
            radius: _this.radius_scale(parseInt(d.magnitude)),
            value: d.correlation,
            name: d.Feature,
            Category: d.Category,
            year: d.Category,
    ...
    BubbleChart.prototype.move_towards_year = function(alpha) {
      return (function(_this) {
        return function(d) {
          var target;
          target = _this.year_centers[d.Category];
    ...
    BubbleChart.prototype.display_years = function() {
      ...
      years_x = {
        "economy": 160, 
        "social": this.width/3, 
        "government": this.width - 300,
         "resources": this.width - 50,
          "population": this.width - 160 
      };
